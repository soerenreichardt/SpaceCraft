...
public class MeshGenerator : MonoBehaviour {
    ...
    private static SmoothTerrainMeshGenerator smoothTerrainMeshGenerator = new SmoothTerrainMeshGenerator();
    private static BlockTerrainMeshGenerator blockTerrainMeshGenerator = new BlockTerrainMeshGenerator();
